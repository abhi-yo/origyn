		...
		<div className="space-y-12">
			...
			<Card
				className={`p-6 border-0 ${
					hasProSubscription
						? "elevated-md bg-primary/5"
						: "elevated-sm bg-muted/30"
				}`}
			>
			...
			<section className="space-y-6">
				...
				<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
					{heroTemplates.map((template) => (
						<Card
							key={template.name}
							className="p-5 elevated-md border-0 transition-all hover:elevated-lg flex flex-col"
						>
							...
							<div className="flex gap-2 mt-3">
								<Button
									size="sm"
									variant="outline"
									className="flex-1 elevated-sm transition-all hover:elevated-md h-9"
									asChild
								>
								...
								{hasProSubscription ? (
									<Button
										size="sm"
										className="flex-1 elevated-md transition-all hover:elevated-lg h-9"
										asChild
									>
			...
			{hasProSubscription && (
				<Card className="p-6 elevated-lg border-0">
					<div className="space-y-3">
						...
						<p className="text-sm text-muted-foreground leading-relaxed">
							If you have any questions about using the templates or need
							customization help, feel free to reach out.
						</p>
						<div className="pt-2">
							<Button
								size="sm"
